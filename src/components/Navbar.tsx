...
const navLinks = [
  ...
  { label: "Shop Cakes", path: "/shop" },
  { label: "Cake Categories", path: "/categories" },
  { label: "Contact Bakery", path: "/contact" },
];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="h-[72px] flex items-center justify-between">
          ...
          <form
            ...
            className="hidden lg:flex items-center w-[260px]
                       rounded-full px-4 py-2 border
                       bg-rose-50 border-rose-200"
          >
            <Search
              className="w-4 h-4 opacity-70 text-gray-600"
              aria-hidden="true"
            />
            <input
              type="search"
        ...
        {open && (
          ...
          >
            <div className="max-w-7xl mx-auto px-4 py-6 flex flex-col gap-5">
              ...
              {/* mobile search */}
              <form role="search" aria-label="Search cakes mobile"
                    className="flex items-center bg-rose-50 rounded-full px-4 py-2">
