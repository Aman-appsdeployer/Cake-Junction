...
/* ================= DATA ================= */
const cakes: Cake[] = [
  { name: "Chocolate Truffle Cake", category: "Best Seller Cake", rating: 4.9, image: cake1 },
  { name: "Birthday Special Cake", category: "Birthday Cake", rating: 4.8, image: cake2 },
  { name: "Elegant Wedding Cake", category: "Wedding Cake", rating: 5.0, image: cake3 },
  { name: "Cupcakes Box", category: "Cupcakes & Desserts", rating: 4.7, image: cake4 },
  { name: "Red Velvet Cake", category: "Red Velvet Cake", rating: 4.8, image: redvalvet },
  { name: "Butterscotch Cake", category: "Butterscotch Cake", rating: 4.6, image: butterScotch },
  { name: "Blueberry Cake", category: "Blueberry Cake", rating: 4.7, image: blueberry },
  { name: "Oreo Cake", category: "Oreo Chocolate Cake", rating: 4.5, image: oreocake },
];
...
const PopularCakes: React.FC = () => {
  return (
    <section
      id="popular-cakes"
      aria-label="Popular cakes and best selling bakery products"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <p className="text-primary font-semibold text-xl sm:text-2xl mb-2">
            Popular Bakery Cakes
          </p>

          {/* SEO heading */}
          <h2 className="font-bold text-gray-900 leading-tight
                         text-2xl sm:text-3xl md:text-4xl lg:text-5xl">
            Best Selling Birthday & Wedding Cakes
          </h2>

          {/* SEO text */}
          <p className="text-gray-600 mt-4 max-w-2xl mx-auto text-sm sm:text-base">
            Discover our most ordered birthday cakes, wedding cakes,
            and custom celebration cakes — freshly baked with premium
            ingredients and top customer ratings.
          </p>
        </motion.header>
              ...
              >
                ...
                <div className="relative aspect-[4/3] overflow-hidden">
                  <img
                    src={cake.image}
                    loading="lazy"
                    alt={`${cake.name} from Cake Junction bakery`}
        ...
        <div className="text-center mt-14">
          <Link
            to="/shop"
            aria-label="View full cake menu"
